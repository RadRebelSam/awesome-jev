...
function main() {
  ...
  const body = [
    ...
    '---',
    '',
    `<sub>${entries.length} entries · ${exclusive} of them absent from both awesomejev.com and jevmade.com · last updated ${today()} · ${stats.review ?? 0} candidates in the [review queue](data/review-queue.md) · generated by [\`tools/fetch.js\`](tools/fetch.js)</sub>`,
  ].join('\n');
